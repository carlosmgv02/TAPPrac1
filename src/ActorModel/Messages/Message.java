 ...
 * <ul>
 *     <li>{@link Message}</li>
 *     <li>{@link ActorModel.Messages.Insult.GetInsultMessage}</li>
 *     <li>{@link ActorModel.Messages.Insult.GetAllInsultsMessage}</li>
 *     <li>{@link ActorModel.Messages.Insult.AddInsultMessage}</li>
 * </ul>
 */
public class Message {
     ...
     */
    public synchronized void setFrom(ActorProxy source) {
        from = source;
    }
